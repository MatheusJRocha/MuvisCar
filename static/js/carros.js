...
console.log("API Base URL:", API_CONFIG.BASE_URL);
    ...
    async function deleteCar(plate) {
        if (!confirm(`Tem certeza que deseja excluir o carro com placa ${formatPlate(plate)}?`)) { 
            return;
        }
        try {
        ...
        carsToRender.forEach(car => {
            ...
            row.innerHTML = `
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button class="text-blue-600 hover:text-blue-900 mr-4 edit-btn" data-plate="${car.license_plate}">
...
// Torna algumas funções globais para uso em HTML
