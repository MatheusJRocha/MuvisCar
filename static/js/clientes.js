...
// DOM elements
        ...
        const notificationContainer = document.getElementById('notificationContainer'); // Adicionado
        ...
        function showNotification(message, type = 'info', duration = 5000) {
            ...
            notificationContainer.appendChild(notification); // Alterado para usar o contêiner
        ...
        function renderClients(clientList) {
            ...
            clientList.forEach(client => {
                ...
                const clientType = client.cpf_cnpj && client.cpf_cnpj.length === 11 ? 'Pessoa Física' : 
                                   (client.cpf_cnpj && client.cpf_cnpj.length === 14 ? 'Pessoa Jurídica' : '-'); // Alterado para '-'
        ...
        async function editClient(id) {
            ...
            if (client.cpf_cnpj) {
                ...
                clientTypeSelect.value = ''; // Define um valor padrão se cpf_cnpj for nulo
            }
            ...
            passwordInput.required = false; // Senha não é obrigatória na edição
